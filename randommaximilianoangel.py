...
|=======================================|
 """)
    ...
    if seleccion == "1": # Condicional "if" que ejecutará la función "random_repetido" si (seleccion == "1") 
        random_repetido() # Llama a la función "random_repetido".
    elif seleccion == "2": # Condicional "elif" que ejecutará la función "random_sin_repetidos" si (seleccion == "2") 
        random_sin_repetidos() # Llama a la función "random_sin_repetidos".
    elif seleccion == "3": # Condicional "elif" que imprimirá un mensaje y hará que termine el ciclo "while", si (seleccion == "3") .
