    ...
    while(candidato <= 4): #and not solucion):
        ...
        if(valida(tablero, candidato, x, y)):
            ...
            if(final(tablero,nx,ny)):
                ...
                print(f"Se encontro {soluciones_encontradas} solucion/es ")
                mostrar_tablero(tablero)
                input("Enter para continuar")
                tablero[nx][ny] = 0
            ...
            while(candidato == 5 and not (x==0 and y==0)):
                ...
                x =nx; y=ny
                #mostrar_tablero(tablero)
    return (soluciones_encontradas > 0 , soluciones_encontradas)
...
mostrar_tablero(tablero)
existe, soluciones = solucion(tablero)

if existe:
    print(f"existen {soluciones} soluciones")
    mostrar_tablero(tablero)
else:
